= IMPORTANT NOTES =
All the icons should be attributed, but for extra explanation:

Icons ending in "-solid" are from Font Awesome Free (https://fontawesome.com), and are under the CC-BY 4.0 License (https://creativecommons.org/licenses/by/4.0).

Brand icons are from Font Awesome (https://fontawesome.com), and are likely trademarked.
